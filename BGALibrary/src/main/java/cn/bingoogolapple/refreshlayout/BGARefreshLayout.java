...
public class BGARefreshLayout extends LinearLayout {
    ...
    private Animator.AnimatorListener mHeaderViewBackListener;//监听HeaderView回弹
    ...
    private void hiddenRefreshHeaderView() {
        ...
        //增加HeaderView回弹监听
        if (mHeaderViewBackListener != null) animator.addListener(mHeaderViewBackListener);
        animator.start();
    }

    /**
     * 设置HeaderView回弹Listener 修改者：朱飞龙
     * @param listener
     */
    public void setHeaderViewBackListener(Animator.AnimatorListener listener) {
        mHeaderViewBackListener = listener;
    }
